...
const EisenhowerMatrix = ()=>{
    ...
    const [editingType, setEditingType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$future$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$future$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadTasks = async ()=>{
            if (user?.premium) {
                try {
                    const tasks = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$tasksyncoperations$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchTasks"])(user.id);
                    const subtasks = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$tasksyncoperations$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchSubtasks"])(user.id);
                    ...
                    tasks.forEach((task)=>{
                        ...
                        updatedTasks[task.quadrant].push({
                            ...task,
    ...
    const addTask = async (quadrant = selectedQuadrant, taskText = newTask)=>{
        if (taskText.trim()) {
            ...
            if (user?.premium) {
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$tasksyncoperations$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["upsertTask"])(user.id, newTask, quadrant);
                } catch (error) {
...
//# sourceMappingURL=components_8088b7._.js.map